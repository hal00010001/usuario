package br.com.ambidextrous.usuario.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final br.com.ambidextrous.usuario.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(br.com.ambidextrous.usuario.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
